...
| id | 名称 | 模式 | 数值 | 商店基价 |
|---|---|---|---|---|
| pistol | 手枪 | 单发直射 | 伤 12 / 射速 2.0 / 弹速 500 / **射程 300** | 40 |
| rifle | 步枪 | 3 连发 | 伤 9 / 射速 1.4 轮 / 弹速 600 / **射程 320** | 80 |
| mg | 机枪 | 散射 ±6° | 伤 5 / 射速 8 / 弹速 550 / **射程 280** | 80 |
| rocket | 火箭炮 | 直射爆炸 | 伤 30 / 射速 0.7 / 弹速 350 / **射程 350** / aoe 90 | 150 |
| grenade | 榴弹炮 | 抛射越障 AoE | 伤 25 / 射速 0.6 / 弹速 420 / **射程 330** / aoe 130 / `arc:true`（无视障碍） | 200 |
| tesla | 磁电枪 | 链电 | 伤 14 / 射速 1.2 / 弹速 800 / **射程 260** / `chain:3`（每跳 -20%） | 250 |
...
- **固定火炮 turret**（键 4，价格 120）：部署于玩家当前位置（数字键消耗 1 个）；伤害 25 / 射速 0.5 / 弹速 350 / 射程 350 / aoe 80 / 耐久 200
...
| id | 名称 | 行为 | 基值 | 价格/把 | 上限 |
|---|---|---|---|---|---|
| drone | 随行无人机 | 环绕玩家（半径 90，角速 2rad/s） | 伤 6 / 射速 2 / 弹速 500 / 射程 250 | 60 | 3 |
| gunner | 随行移动火炮 | 跟随玩家身后 60px | 伤 15 / 射速 1 / 弹速 400 / 射程 320 / aoe 60 | 90 | 3 |
| sniper | 随行远程火炮 | 跟随玩家 100px | 伤 30 / 射速 0.4 / 弹速 700 / 射程 500 | 120 | 2 |
